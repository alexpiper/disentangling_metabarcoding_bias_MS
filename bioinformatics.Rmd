...
# Introduction 
The first run: 190412_M03633_0313_000000000-CGK9B
The second run: 200203_M03633_0388_000000000-CJL7D
...
We will use BLAST to assign our sequences to a local datbase
```{r IDTAXA BLAST}
